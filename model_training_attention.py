...
class MIA_train: # main class for every thing
    ...
    def __init__(self, arch, cutting_layer, batch_size, n_epochs,lambd=1, scheme="V2_epoch", num_client=1, dataset="cifar10",
                 ...
                 use_attention_classifier=False, num_slots=3, attention_heads=8, attention_dropout=0.1, var_threshold: float = 0.1):
        ...
        # compatibility with CLI args for naming/threshold usage
