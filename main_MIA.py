...
import logging
import model_training_attention
...
#attention setting ()
parser.add_argument('--use_attention_classifier', action='store_true', default=True, help='if True, use attention classifier instead of GMM')
...
parser.add_argument('--attention_dropout', default=0.1, type=float, help='dropout rate for attention')
...
mi = model_training_attention.MIA_train(args.arch, cutting_layer, batch_size,lambd=args.lambd, n_epochs = args.num_epochs, scheme = args.scheme,
